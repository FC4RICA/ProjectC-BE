...
func (s *APIServer) Run() {
	...
	router.HandleFunc("/result/{user-id}", handlers.WithJWTAuth(makeHTTPHandleFunc(s.handleCreateResult), s.store))

	router.HandleFunc("/image", makeHTTPHandleFunc(s.handleCreateImage))
